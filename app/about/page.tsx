  ...
  return (
    <main className="min-h-screen bg-white text-[#111111]">
      ...
      <section className="py-16 max-w-7xl mx-auto px-6">
        <div className="rounded-3xl border border-[#DEDEDE] bg-white p-10 sm:p-14 text-center shadow-sm">
          <span className="badge-pill-gold mb-4 font-dmsans">TRADE CONNECT</span>
