    ...
    <main className="min-h-screen bg-white text-[#111111]">
      ...
      <section className="py-12 sm:py-16 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-16">
          <div className="badge-pill-gold mb-3 font-dmsans">CORE COMPETENCIES</div>
      ...
      <section className="py-24 bg-zinc-50 border-y border-[#DEDEDE]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <div className="badge-pill-gold mb-3 font-dmsans">SEAMLESS PIPELINE</div>
            <h2 className="text-2xl sm:text-3xl font-bold font-space tracking-tight text-[#111111] mb-3">
      ...
      <section className="py-20 max-w-7xl mx-auto px-6 text-center">
        <div className="rounded-3xl border border-[#DEDEDE] bg-white p-12 sm:p-16 shadow-sm">
          <div className="badge-pill-gold mb-4 font-dmsans">TRADE ACTION</div>
          <h2 className="text-2xl sm:text-3xl font-bold font-space tracking-tight text-[#111111] mb-3">
